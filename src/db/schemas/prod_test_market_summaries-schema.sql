...
--
-- Name: prod_test_market_summaries; Type: TABLE; Schema: public; Owner: patrickmckelvy; Tablespace: 
--
...
CREATE INDEX marketname_idx ON prod_test_market_summaries USING btree (marketname);
...
CREATE INDEX ticker_nonce_idx ON prod_test_market_summaries USING btree (ticker_nonce);
