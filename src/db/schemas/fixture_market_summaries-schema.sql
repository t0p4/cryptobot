...
--
-- Name: fixture_market_summaries; Type: TABLE; Schema: public; Owner: patrickmckelvy
--
...
--
-- Name: fixture_market_summaries id; Type: DEFAULT; Schema: public; Owner: patrickmckelvy
--
...
--
-- Name: fixture_market_summaries fixture_market_summaries_pkey; Type: CONSTRAINT; Schema: public; Owner: patrickmckelvy
--

ALTER TABLE ONLY fixture_market_summaries
    ADD CONSTRAINT fixture_market_summaries_pkey PRIMARY KEY (id);


--
-- Name: fixture_marekt_summaries_marketname_idx; Type: INDEX; Schema: public; Owner: patrickmckelvy
--

CREATE INDEX fixture_marekt_summaries_marketname_idx ON fixture_market_summaries USING btree (marketname);


--
-- Name: fixture_market_summaries_ticker_nonce_idx; Type: INDEX; Schema: public; Owner: patrickmckelvy
--

CREATE INDEX fixture_market_summaries_ticker_nonce_idx ON fixture_market_summaries USING btree (ticker_nonce);
